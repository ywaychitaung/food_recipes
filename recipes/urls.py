...
urlpatterns = [
    ...
    path('recipe/<slug:the_slug>/update', views.RecipeUpdateView.as_view(), name="recipes-update"),
    path('recipe/<slug:the_slug>/delete', views.RecipeDeleteView.as_view(), name="recipes-delete"),
